...
public class MapScale extends Entity {
	...
	private void repopulate() {
		...
		Text t = new Text(MARGIN + (width / 2), MARGIN + lineHeight + 5, ACadEngineActivity.measurementFont, MutablePolygon.formatDistance(gridIncrement * parts), 30, new TextOptions(HorizontalAlign.CENTER), vboManager);
